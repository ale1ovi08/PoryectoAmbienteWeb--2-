...
<body>
    ...
    $sql = "SELECT v.id_venta, pr.nombre_producto, v.cantidad, v.total, v.fecha_venta
    FROM ventas v
    ...
    <div class="control-Ventas">
        <h2 class="titulo-Ventas">Control de Ventas</h2>

        <div class="contenedor-botones">
            <a href="../dashboard.html" class="boton-regresar">Regresar</a>
            <a href="agregar_venta.php" class="btn-agregar">Agregar Venta</a>
        </div>
            ...
            <tbody>
                <?php while ($row = $result->fetch_assoc()) { ?>
                    <tr>
                        ...
                        <td>
                            <a href="Editar_Venta.php?id_venta=<?= $row['id_venta']; ?>" class="btn-accion editar">Editar</a> -
                            <a href="eliminar_Venta.php?id_venta=<?= $row['id_venta']; ?>" class="btn-accion eliminar">Eliminar</a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
